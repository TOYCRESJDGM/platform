...
"""
ORM class to interact with the Emitters table in the database
"""
class Emitters(OrmBaseModel):
...
event.listen(
    Emitters.__table__, "after_create", restart_seq.execute_if(dialect="mysql")
)    